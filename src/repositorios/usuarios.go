...
// Tras todos os usuarios que atendem a um filtro de nome ou nick
...
// Traz um unico usuario que tem o id igual ao que foi passado na requisição
...
// Altera as informacoes de um usuario que tem o id igual ao que foi passado na requisição
...
// Exclui as informaçoes de um usuario que tem o id igual ao que foi passado na requisição
...
// Busca um usuario por email no banco de dados e retorna seu id e senha com hash
...
// Tras os dados de todos os seguidores de um usuario
...
// Retorna todos usuarios que um determinado usuario está seguindo
...
// Retorna a senha de um usuario pelo id
